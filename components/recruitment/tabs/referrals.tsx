            ...
            <>
              ...
              {jobTotalPages > 1 && (
                <div className="mt-6 flex items-center justify-center gap-2">
                  <button suppressHydrationWarning onClick={() => setJobPage(1)} disabled={jobPage === 1} className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed">
                    <ChevronsLeft size={16} />
                  </button>
                  <button suppressHydrationWarning onClick={() => setJobPage((p) => Math.max(1, p - 1))} disabled={jobPage === 1} className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed">
                    <ChevronLeft size={16} />
                  </button>
                  <span className="px-3 text-sm text-slate-600">Page {jobPage} of {jobTotalPages}</span>
                  <button suppressHydrationWarning onClick={() => setJobPage((p) => Math.min(jobTotalPages, p + 1))} disabled={jobPage === jobTotalPages} className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed">
                    <ChevronLeft size={16} className="rotate-180" />
                  </button>
                  <button suppressHydrationWarning onClick={() => setJobPage(jobTotalPages)} disabled={jobPage === jobTotalPages} className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed">
            ...
            <>
              ...
              {referralTotalPages > 1 && (
                <div className="mt-4 flex items-center justify-center gap-2">
                  <button suppressHydrationWarning onClick={() => setReferralPage(1)} disabled={referralPage === 1} className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed">
                    <ChevronsLeft size={16} />
                  </button>
                  <button suppressHydrationWarning onClick={() => setReferralPage((p) => Math.max(1, p - 1))} disabled={referralPage === 1} className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed">
                    <ChevronLeft size={16} />
                  </button>
                  <span className="px-3 text-sm text-slate-600">Page {referralPage} of {referralTotalPages}</span>
                  <button suppressHydrationWarning onClick={() => setReferralPage((p) => Math.min(referralTotalPages, p + 1))} disabled={referralPage === referralTotalPages} className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed">
                    <ChevronLeft size={16} className="rotate-180" />
                  </button>
                  <button suppressHydrationWarning onClick={() => setReferralPage(referralTotalPages)} disabled={referralPage === referralTotalPages} className="rounded-lg border border-slate-200 p-2 text-slate-600 hover:bg-slate-50 disabled:opacity-30 disabled:cursor-not-allowed">
                    <ChevronsRight size={16} />
                  </button>
                </div>
              )}
