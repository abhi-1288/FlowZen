...
const modalClass = "w-full max-w-lg rounded-xl bg-[var(--c-bg-elevated)] p-5 shadow-xl";
          ...
          {loading ? (
            ...
            data.categories.length === 0 ? (
              ...
              data.categories.map((cat) => {
                ...
                return (
                  <div key={cat.name} className="rounded-lg neu-inset p-3">
                    <div className="flex items-center gap-3">
                      ...
                      {doc ? (
                        <a href={doc.fileUrl} target="_blank" rel="noopener noreferrer"
                          className="rounded-md neu-card px-3 py-1 text-[11px] font-medium text-indigo-600 hover:bg-indigo-50 transition">
                          View
                        </a>
                      ) : (
                    ...
                    {doc && doc.fieldValues && doc.fieldValues.length > 0 ? (
                      <div className="mt-2 border-t border-[var(--c-border-light)] pt-2 space-y-1">
