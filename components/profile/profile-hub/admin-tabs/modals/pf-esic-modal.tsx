  ...
  return (
    <div className={overlayClass}>
      <div className={modalClass}>
        <h3 className="text-sm font-semibold text-slate-900">PF, ESIC & TDS Details</h3>
        ...
        <div className="mt-4 space-y-4">
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="text-xs text-slate-700">Exempt from PF deduction</span>
          </label>
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="text-xs text-slate-700">Exempt from ESIC deduction</span>
          </label>
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="text-xs text-slate-700">Exempt from TDS deduction</span>
          </label>
        </div>
