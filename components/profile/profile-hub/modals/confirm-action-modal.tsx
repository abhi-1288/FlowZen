  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center neu-overlay p-4">
      <div className="w-full max-w-md rounded-2xl bg-[var(--c-bg-card)] p-6 shadow-xl dark:bg-[#000000]">
        ...
        {!noInput && confirmWord ? (
          <input
            className="mt-4 w-full rounded-lg border border-[var(--c-border-light)] px-3 py-2.5 dark:border-zinc-800 dark:bg-[#000000]"
        ...
        <div className="mt-5 flex justify-end gap-3">
          <button className="rounded-full border border-[var(--c-border-light)] px-4 py-2 text-sm dark:border-zinc-800" onClick={onCancel}>
            Cancel
          </button>
          <button
            className="neu-btn neu-btn-danger rounded-full px-4 py-2 text-sm font-medium disabled:cursor-not-allowed"
