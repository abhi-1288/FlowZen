...
export function renderRecruitmentOfferLetterHtml(input: RecruitmentOfferLetterInput) {
  ...
  const isSigned = Boolean(offer.isSigned);
...
<body>
  ...
  <main class="letter-page">
    ...
    <footer class="footer">
      ${joiningDate ? `<p style="margin:0 0 8px;font-size:12px;color:#475569;">Please bring this Offer Letter to ${escapeHtml(companyName)} on your joining date (${escapeHtml(joiningDate)}).</p>` : ""}
      <p style="margin:0;">Generated by FlowZen &middot; ${escapeHtml(compactGeneratedDate)}</p>
    </footer>
  </main>
</body>
</html>`;
