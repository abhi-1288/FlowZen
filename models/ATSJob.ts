...
const ATSJobSchema = new Schema(
  {
    ...
    salaryType: { type: String, enum: ["per-annum", "per-month", "per-day", "per-hour"], default: "per-annum" },
    currency: { type: String, default: "INR", trim: true },
    openings: { type: Number, default: 1, min: 1 },
    durationMonths: { type: Number, default: null, min: 1, max: 60 },
    durationDays: { type: Number, default: null, min: 0, max: 365 },
    durationHours: { type: Number, default: null, min: 0, max: 9999 },
    durationYears: { type: Number, default: null, min: 0, max: 50 },
