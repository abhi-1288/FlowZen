...
const JoinRequestSchema = new Schema(
  {
    ...
    kind: { type: String, enum: ["company", "team", "identity-code", "salary", "salary-advance", "quit-company", "quit-team", "quit-company-board-transfer", "salary-increment", "role-transfer", "document-letter", "region-address", "id-card"], required: true, index: true },
