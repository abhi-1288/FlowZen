...
const JoinRequestSchema = new Schema(
  {
    ...
    kind: { type: String, enum: ["company", "team", "identity-code", "salary", "quit-company", "quit-team", "quit-company-board-transfer", "salary-increment", "role-transfer", "document-letter"], required: true, index: true },
