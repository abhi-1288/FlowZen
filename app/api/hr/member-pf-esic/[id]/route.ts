...
export async function PATCH(request: Request, { params }: Params) {
  ...
  let body: { pfNumber?: string; pfDeductionAmount?: number; esicNumber?: string; esicDeductionAmount?: number };
  try {
  ...
  }).select("name pfNumber pfDeductionAmount esicNumber esicDeductionAmount");
