...
function JobDetailPage() {
  ...
  const applyFields = [
    ...
    { icon: CalendarClock, label: "Closes", value: job.autoCloseDate ? fmtJobDateTime(job.autoCloseDate) : "Rolling" },
                ...
                <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-slate-500 dark:text-zinc-400">
                  ...
                  {job.autoCloseDate && (
                    <span className="inline-flex items-center gap-1.5">
                      ...
                      {fmtJobDateTime(job.autoCloseDate)}
                    </span>
                  )}
